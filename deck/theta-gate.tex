...
\IfFontExistsTF{IBM Plex Sans}{
  \setsansfont{IBM Plex Sans}[UprightFont=* Light, BoldFont=* SemiBold]
}{
...
\begin{frame}[t]{Confirmation is two things wearing one name}
  ...
  assertion that fails closed. \textbf{Theta Gate does the same thing, with eighteen
...
\begin{frame}[t]{Architecture}
  ...
  \begin{tikzpicture}[scale=0.9,transform shape,
    ...
    \node[guard,right=0.7cm of resolve] (risk) {\textcolor{accent}{risk.py}\\18 gates, pure};
  ...
  \begin{columns}[T]
    \begin{column}{0.49\textwidth}
      ...
      \begin{itemize}\itemsep1pt
        ...
        \item $6 \leq$ DTE $\leq 9$; short leg $0.16 \leq |\delta| \leq 0.25$
    ...
    \begin{column}{0.49\textwidth}
      ...
      \begin{itemize}\itemsep1pt
        ...
        \item ATM IV $-$ 20d realised vol $\geq$ 2.0 points
      \end{itemize}
      \vspace{0.22em}
      ...
      \begin{itemize}\itemsep1pt
        ...
        \item equity $\leq$ \$98{,}000 $\rightarrow$ HALT and close out
      \end{itemize}
    \end{column}
  \end{columns}
...
\begin{frame}[t]{The strategy, and its honest edge}
  ...
  \lead{Short credit vertical on SPY or QQQ. \$5 wide. 6--9 DTE. Short leg at 0.16--0.25
  delta. Exactly one contract, all week.}
...
\begin{frame}[t]{Built, and what it cost}
  ...
  \begin{columns}[T]
    \begin{column}{0.52\textwidth}
      ...
      \begin{itemize}\itemsep2pt
        \item \kbd{risk.py} --- 18 gates, pure functions, no I/O, time injected
    ...
    \begin{column}{0.44\textwidth}
      \panel{%
        ...
        \vspace{0.29em}
        An adversarial review pass over \kbd{loop.py} caught six real defects, two of them
        blockers, before any of it was trusted with an order.}
    \end{column}
  \end{columns}
