...
\begin{frame}[t]{What the agent did}
  ...
  \vspace{0.36em}
  \stat{0.22\textwidth}{realised p\&l}{\$95.00}\hfill
  \stat{0.22\textwidth}{trades closed}{2}\hfill
  \stat{0.22\textwidth}{win rate}{100\%}\hfill
  \stat{0.22\textwidth}{max drawdown}{-0.15\%}
...
\begin{frame}[t]{What six sessions can and cannot show}
  ...
  \lead{The sample is 2 trades across six sessions. That is statistically
  ...
  guard held} --- and that is measurable at n~=~2, whereas edge is not.}
\end{frame}
...
\begin{frame}[t]{Built, and what it cost}
  ...
  \vspace{0.5em}
  \textcolor{muted}{\small The honest failure mode: roughly 7:1 --- seven \$120 wins pay for
  one \$880 max loss. The gates cap the left tail; they do not change the sign of a week.}
\end{frame}
